  ...
  return (
    <div className="space-y-xxl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-lg animate-slide-up">
        <div>
          <h1 className="font-display text-heading-1 text-ink mb-xs">Applications</h1>
        ...
        {loading ? (
          <div className="flex items-center justify-center py-section">
            <div className="flex items-center gap-sm text-steel">
              ...
              <span className="font-sans text-body-sm">Loading applications...</span>
            </div>
          </div>
        ) : (
          <DataTable
      ...
      <Modal open={showNewModal} onClose={() => setShowNewModal(false)} title="New Application" size="md">
